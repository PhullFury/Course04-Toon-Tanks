...
// End Cross Module References
	...
	void ATankGameModeBase::GameOver(bool GameOver)
	{
		TankGameModeBase_eventGameOver_Parms Parms;
		Parms.GameOver=GameOver ? true : false;
	...
	void Z_Construct_UFunction_ATankGameModeBase_GameOver_Statics::NewProp_GameOver_SetBit(void* Obj)
	{
		((TankGameModeBase_eventGameOver_Parms*)Obj)->GameOver = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ATankGameModeBase_GameOver_Statics::NewProp_GameOver = { "GameOver", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(TankGameModeBase_eventGameOver_Parms), &Z_Construct_UFunction_ATankGameModeBase_GameOver_Statics::NewProp_GameOver_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATankGameModeBase_GameOver_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATankGameModeBase_GameOver_Statics::NewProp_GameOver,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ATankGameModeBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ATankGameModeBase_GameOver, "GameOver" }, // 1382533261
		{ &Z_Construct_UFunction_ATankGameModeBase_GameStart, "GameStart" }, // 3392429467
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ATankGameModeBase, 2760603836);
